-- ============================================
-- FRENCHYBOT - Installation BDD Multi-tenant
-- Usage: mysql -u root -p frenchybot < install.sql
-- ============================================
...
-- ============================================
-- TABLE: Chatbots (table maitresse multi-tenant)
-- ============================================
...
CREATE TABLE IF NOT EXISTS chatbot_intentions (
    ...
    UNIQUE KEY uk_chatbot_intention (chatbot_id, intention_key),
    FOREIGN KEY (chatbot_id) REFERENCES chatbots(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS leads (
    ...
    nb_chambres VARCHAR(10) DEFAULT NULL,
    type_maison VARCHAR(50) DEFAULT NULL,
    modele_interesse INT DEFAULT NULL,
    terrain_interesse INT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS chatbot_analytics (
    ...
    UNIQUE KEY uk_chatbot_date_hour (chatbot_id, date, hour),
    INDEX idx_chatbot (chatbot_id),
    INDEX idx_date (date),
    FOREIGN KEY (chatbot_id) REFERENCES chatbots(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS chatbot_user_patterns (
    ...
    UNIQUE KEY uk_chatbot_pattern (chatbot_id, pattern_type, pattern_value),
    INDEX idx_type_freq (pattern_type, frequency)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ============================================
-- TABLE: Webhooks / Integrations
-- ============================================
...
-- VERIFICATION
-- ============================================
SELECT 'FrenchyBot - Installation terminee !' AS message;
SELECT CONCAT('Tables creees: ',
    (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name IN (
        'chatbots', 'admins', 'chatbot_conversations', 'chatbot_messages',
        'chatbot_intentions', 'leads', 'chatbot_ab_tests', 'chatbot_followups',
        'chatbot_analytics', 'chatbot_user_patterns', 'chatbot_webhooks'
    ))
) AS stats;
